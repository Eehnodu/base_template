          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <InputBox
                ...
                leftIcon={<Mail className="w-5 h-5 text-text-placeholder" />}
              />
            </div>
            ...
            <div className="flex flex-col gap-2 relative">
              <InputBox
                ...
                className="transition-all"
                leftIcon={<Lock className="w-5 h-5 text-text-placeholder" />}
                ...
                rightIcon={
                  ...
                  >
                    {showPw ? (
                      ...
                      <EyeOff className="w-5 h-5 text-text-placeholder" />
                    )}
                  </button>
                }
              />
